...
FLIGHTMAP_SHOW_ZONE_TOOLTIP             = "顯示區域提示";
FLIGHTMAP_SHOW_ZONE_TOOLTIP_TIP         = "在大陸地圖上懸停時顯示區域提示。";
FLIGHTMAP_SHOW_ZONE_LEVEL_RANGES        = "顯示区域等級範圍";
